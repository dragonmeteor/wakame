...
public class Matrix4f implements java.io.Serializable, Cloneable {
   ...
   /**
     ...
     */  
    public Matrix4f(Quat4f q1, javax_.vecmath.Vector3f t1, float s)
    {
   ...
   /**
     ...
     */
   public Matrix4f(javax_.vecmath.Matrix4d m1)
   {
   ...
   /**
     ...
     * @param s   the scale value applied to the rotational components
     */
    public Matrix4f(javax_.vecmath.Matrix3f m1, javax_.vecmath.Vector3f t1, float s)
    {
        this.m00 = m1.m00*s;
        this.m01 = m1.m01*s;
        this.m02 = m1.m02*s;
   ...
   /**  
	...
	switch (row) 
	  ...
	  case 0:
		...
		break;
	      default:
		throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix4f0"));
	      }
	    break;
	...
	throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix4f1"));
    }
    ...
    public final void getRow(int row, Vector4f v) {
        if( row == 0 ) {
          ...
          throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix4f2"));
        }
    ...
    public final void getColumn(int column, Vector4f v) {
        if( column == 0 ) {
          ...
          throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix4f4"));
        }
   ...
   /** 
     ...
     * @param m1 matrix into which the rotational component is placed
     */  
    public final void get(javax_.vecmath.Matrix3f m1)
    {
	double[]    tmp_rot = new double[9];  // scratch matrix
	double[]    tmp_scale = new double[3];  // scratch matrix
   ...
   /**
     ...
     */   
    public final float get(javax_.vecmath.Matrix3f m1, javax_.vecmath.Vector3f t1)
    {     
	double[]    tmp_rot = new double[9];  // scratch matrix
	double[]    tmp_scale = new double[3];  // scratch matrix
   ...
   /**
     ...
     */
    public final void get(javax_.vecmath.Vector3f trans)
    {  
        trans.x = m03;
        trans.y = m13;
        trans.z = m23;
  ...
  /**  
    ...
    */
    public final void getRotationScale(javax_.vecmath.Matrix3f m1)
    {    
   ...
   */  
    public final void setRotationScale(javax_.vecmath.Matrix3f m1)
    {    
	...
	default:
            throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix4f6"));
	}
    }
	...
	default:
            throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix4f9"));
	}
    }
   ...
   /**
     ...
     */
    public final void set(javax_.vecmath.AxisAngle4f a1)
    {
     ...
     * @param q1 the quaternion to be converted
     */
    public final void set(javax_.vecmath.Quat4d q1)
    {
     ...
     * @param a1 the axis and angle to be converted
     */
    public final void set(javax_.vecmath.AxisAngle4d a1)
    {
     ...
     */
    public final void set(javax_.vecmath.Quat4d q1, javax_.vecmath.Vector3d t1, double s)
    {
     ...
     * @param s the scale value
     */
    public final void set(Quat4f q1, javax_.vecmath.Vector3f t1, float s)
    {
     ...
     */
    public final void set(javax_.vecmath.Matrix4d m1)
    {
	this.m00 = (float) m1.m00;
	this.m01 = (float) m1.m01;
	this.m02 = (float) m1.m02;
  ...
  public final void invert()
  {
	...
	if (!luDecomposition(temp, row_perm)) {
	    ...
	    throw new SingularMatrixException(javax_.vecmath.VecMathI18N.getString("Matrix4f12"));
	}
...

	{
		...
		if (imax < 0) {
		    throw new RuntimeException(javax_.vecmath.VecMathI18N.getString("Matrix4f13"));
		}
     ...
     */  
    public final void set(javax_.vecmath.Matrix3f m1)
    {
     ...
     */
    public final void set(javax_.vecmath.Vector3f v1)
    {
	this.m00 = (float) 1.0;
	this.m01 = (float) 0.0;
	this.m02 = (float) 0.0;
   ...
   /**
     ...
     */
    public final void set(float scale, javax_.vecmath.Vector3f t1)
    {
	this.m00 = scale;
	this.m01 = (float) 0.0;
	this.m02 = (float) 0.0;
    ...
    /**
      ...
      * @param scale the scale factor for the matrix
      */
    public final void set(javax_.vecmath.Vector3f t1, float scale)
    {
	this.m00 = scale;
	this.m01 = (float) 0.0;
	this.m02 = (float) 0.0;
   ...
   /**
     ...
     */
    public final void set(javax_.vecmath.Matrix3f m1, javax_.vecmath.Vector3f t1, float scale)
    {
   ...
   /**
     ...
     */
    public final void set(Matrix3d m1, javax_.vecmath.Vector3d t1, double scale)
    {
   ...
   /**
     ...
     */  
    public final void setTranslation(javax_.vecmath.Vector3f trans)
    {
       m03 = trans.x; 
       m13 = trans.y;
       m23 = trans.z;
   ...
   /**   
    ...
    public int hashCode() {
	long bits = 1L;
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m00);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m01);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m02);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m03);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m10);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m11);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m12);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m13);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m20);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m21);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m22);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m23);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m30);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m31);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m32);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(m33);
   ...
   */
    public final void transform(javax_.vecmath.Tuple4f vec, javax_.vecmath.Tuple4f vecOut)
    {
           float x,y,z;
   ...
   * @param vec  the single precision vector to be transformed
   */
    public final void transform(javax_.vecmath.Tuple4f vec)
    {
         float x,y,z;
   ...
   */
    public final void transform(javax_.vecmath.Vector3f normal, javax_.vecmath.Vector3f normalOut)
    {
        float x,y;
   ...
   * @param normal   the input normal to be transformed.
   */
    public final void transform(javax_.vecmath.Vector3f normal)
    {
        float x, y;
   ...
   /**
     ...
     */  
   public final void setRotation( javax_.vecmath.Matrix3f m1){
       double[]    tmp_rot = new double[9];  // scratch matrix
       double[]    tmp_scale = new double[3];  // scratch matrix
   ...
   /** 
     ...
     * @param q1   the quaternion that specifies the rotation
     */   
    public final void setRotation(javax_.vecmath.Quat4d q1){
	double[]    tmp_rot = new double[9];  // scratch matrix
	double[]    tmp_scale = new double[3];  // scratch matrix
   ...
   /** 
     ...
     */   
    public final void setRotation(javax_.vecmath.AxisAngle4f a1){
	double[]    tmp_rot = new double[9];  // scratch matrix
	double[]    tmp_scale = new double[3];  // scratch matrix
