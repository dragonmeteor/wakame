...
public class AxisAngle4f implements java.io.Serializable, Cloneable {
  ...
  {
        javax_.vecmath.Matrix3f m3f = new javax_.vecmath.Matrix3f();
  ...
  public final void set(Matrix3d m1)
  {
   ...
   /**
    ...
    public int hashCode() {
	long bits = 1L;
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(x);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(y);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(z);
	bits = 31L * bits + (long) javax_.vecmath.VecMathUtil.floatToIntBits(angle);
