...
public class AxisAngle4d implements java.io.Serializable, Cloneable {
     ...
     * @since vecmath 1.2
     */
    public AxisAngle4d(javax_.vecmath.Vector3d axis, double angle) {
	this.x = axis.x;
	this.y = axis.y;
	this.z = axis.z;
	this.angle = angle;
     ...
     * @since vecmath 1.2
     */
    public final void set(javax_.vecmath.Vector3d axis, double angle) {
	this.x = axis.x;
	this.y = axis.y;
	this.z = axis.z;
	this.angle = angle;
   ...
   /**
    ...
    public int hashCode() {
	long bits = 1L;
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(x);
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(y);
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(z);
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(angle);
