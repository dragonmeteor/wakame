...
public class Matrix3d implements java.io.Serializable, Cloneable {
   ...
   /**
     ...
     *  @param m1  the source matrix
     */
   public Matrix3d(javax_.vecmath.Matrix3f m1)
   {
        this.m00 = m1.m00;
        this.m01 = m1.m01;
        this.m02 = m1.m02;
   ...
   /**
	...
	switch (row)
	  ...
	  case 0:
		...
		break;
	      default:
		throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix3d0"));
	      }
	    break;
	...
	throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix3d1"));
    }
    ...
    public final void getRow(int row, Vector3d v) {
        if( row == 0 ) {
          ...
          throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix3d2"));
        }
    ...
    public final void getColumn(int column, Vector3d v) {
        if( column == 0 ) {
           ...
           throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix3d4"));
        }
	...
	default:
	  throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix3d6"));
	}
    }
	...
	default:
            throw new ArrayIndexOutOfBoundsException(javax_.vecmath.VecMathI18N.getString("Matrix3d9"));
	}
    }
   ...
   /**
	...
	if (!luDecomposition(tmp, row_perm)) {
	    ...
	    throw new SingularMatrixException(javax_.vecmath.VecMathI18N.getString("Matrix3d12"));
	}
...

	{
		...
		if (imax < 0) {
		    throw new RuntimeException(javax_.vecmath.VecMathI18N.getString("Matrix3d13"));
		}
    ...
    public final void mulTransposeRight(Matrix3d m1, Matrix3d m2)
  {
   ...
   /**
    ...
    public int hashCode() {
	long bits = 1L;
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(m00);
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(m01);
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(m02);
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(m10);
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(m11);
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(m12);
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(m20);
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(m21);
	bits = 31L * bits + javax_.vecmath.VecMathUtil.doubleToLongBits(m22);
  ...
  /**
   ...
   /**
     ...
     */
    public final void transform(javax_.vecmath.Tuple3d t) {
     double x,y,z;
   ...
   /**
     ...
     */
    public final void transform(javax_.vecmath.Tuple3d t, javax_.vecmath.Tuple3d result) {
     double x,y,z;
        x = m00* t.x + m01*t.y + m02*t.z;
        y = m10* t.x + m11*t.y + m12*t.z;
