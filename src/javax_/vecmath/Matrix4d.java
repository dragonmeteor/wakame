...
public class Matrix4d implements java.io.Serializable, Cloneable {
   ...
   /**
     ...
     */
    public Matrix4d(Quat4d q1, javax_.vecmath.Vector3d t1, double s)
    {  
   ...
   /** 
     ...
     * @param s   the scale value applied to the rotational components 
     */  
    public Matrix4d(Quat4f q1, javax_.vecmath.Vector3d t1, double s)
    {
        m00 = s*(1.0 - 2.0*q1.y*q1.y - 2.0*q1.z*q1.z);
        m10 = s*(2.0*(q1.x*q1.y + q1.w*q1.z));
        m20 = s*(2.0*(q1.x*q1.z - q1.w*q1.y));
   ...
   /**
     ...
     * @param s   the scale value applied to the rotational components
     */
    public Matrix4d(Matrix3f m1, javax_.vecmath.Vector3d t1, double s)
    {
        this.m00 = m1.m00*s; 
        this.m01 = m1.m01*s; 
        this.m02 = m1.m02*s; 
   ...
   /**   
     ...
     * @param s   the scale value applied to the rotational components
     */  
    public Matrix4d(Matrix3d m1, javax_.vecmath.Vector3d t1, double s)
    {
        this.m00 = m1.m00*s;  
        this.m01 = m1.m01*s;  
        this.m02 = m1.m02*s;  
   ...
   /**
     ...
     */  
    public final double get(Matrix3d m1, javax_.vecmath.Vector3d t1)
    {    
   ...
   /**   
     ...
     * @return  the scale component of this transform
     */  
    public final double get(Matrix3f m1, javax_.vecmath.Vector3d t1){
   ...
   /**
     ...
     */  
    public final void get(javax_.vecmath.Vector3d trans)
    {
        trans.x = m03;
        trans.y = m13;
        trans.z = m23;
   ...
   */ 
   ...
   /**
     ...
     */
    public final void set(Quat4d q1, javax_.vecmath.Vector3d t1, double s)
    {  
     ...
     * @param s the scale value
     */  
    public final void set(Quat4f q1, javax_.vecmath.Vector3d t1, double s)
    {
	this.m00 = s*(1.0 - 2.0*q1.y*q1.y - 2.0*q1.z*q1.z);
	this.m10 = s*(2.0*(q1.x*q1.y + q1.w*q1.z));
	this.m20 = s*(2.0*(q1.x*q1.z - q1.w*q1.y));
  ...
  public final void invert()
  {
     ...
     */
    public final void set(javax_.vecmath.Vector3d v1)
    {
	this.m00 = 1.0;
	this.m01 = 0.0;
	this.m02 = 0.0;
     ...
     * @param v1 the translation amount
     */
    public final void set(double scale, javax_.vecmath.Vector3d v1)
    {
	this.m00 = scale;
	this.m01 = 0.0;
	this.m02 = 0.0;
   ...
   /**
     ...
     * @param scale the scale factor for the matrix
     */
    public final void set(javax_.vecmath.Vector3d v1, double scale)
    {
	this.m00 = scale;
	this.m01 = 0.0;
	this.m02 = 0.0;
   ...
   /** 
     ...
     */   
    public final void setTranslation(javax_.vecmath.Vector3d trans)
    { 
       m03 = trans.x;  
       m13 = trans.y;
       m23 = trans.z; 
   ...
   */
    public final void transform(javax_.vecmath.Vector3d normal, javax_.vecmath.Vector3d normalOut)
    {
        double x,y;
   ...
   * @param normal   the input normal to be transformed.
   */
    public final void transform(javax_.vecmath.Vector3d normal)
    {
        double x, y;
