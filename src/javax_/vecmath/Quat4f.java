 ...
 *
 */
public class Quat4f extends javax_.vecmath.Tuple4f implements java.io.Serializable {
  ...
  public Quat4f(Quat4d q1)
  {
     ...
     */  
    public Quat4f(javax_.vecmath.Tuple4f t1)
    { 
      float mag;
     ...
     */  
    public Quat4f(javax_.vecmath.Tuple4d t1)
    {
      double mag;
 ...
 /**
   ...
   */
   public final void set(javax_.vecmath.Matrix4f m1)
   {
     ...
     */
    public final void set(javax_.vecmath.Matrix3d m1)
    {
     ...
     */
    public final void set(javax_.vecmath.AxisAngle4f a)
    {
	float mag,amag;
     ...
     * @param a  the AxisAngle to be emulated
     */
    public final void set(javax_.vecmath.AxisAngle4d a)
    {
	float mag,amag;
	// Quat = cos(theta/2) + sin(theta/2)(roation_axis) 
