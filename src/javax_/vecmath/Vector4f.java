 ...
 *
 */
public class Vector4f extends javax_.vecmath.Tuple4f implements java.io.Serializable {
  ...
  public Vector4f(Vector4d v1)
  {
     ...
     */  
    public Vector4f(javax_.vecmath.Tuple4f t1)
    {
       super(t1);
    }
     ...
     */  
    public Vector4f(javax_.vecmath.Tuple4d t1)
    {
       super(t1); 
    }
     ...
     * @since vecmath 1.2
     */
    public Vector4f(javax_.vecmath.Tuple3f t1) {
  ...
  public Vector4f()
  {
     ...
     * @since vecmath 1.2
     */
    public final void set(javax_.vecmath.Tuple3f t1) {
	this.x = t1.x;
	this.y = t1.y;
	this.z = t1.z;
	this.w = 0.0f;
