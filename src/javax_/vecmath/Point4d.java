 ...
 *
 */
public class Point4d extends javax_.vecmath.Tuple4d implements java.io.Serializable {
     ...
     */  
    public Point4d(javax_.vecmath.Tuple4f t1)
    {    
       super(t1);  
    } 
     ...
     */   
    public Point4d(javax_.vecmath.Tuple4d t1)
    { 
       super(t1); 
    } 
     ...
     * @since vecmath 1.2
     */
    public Point4d(javax_.vecmath.Tuple3d t1) {
     ...
     * @since vecmath 1.2
     */
    public final void set(javax_.vecmath.Tuple3d t1) {
	this.x = t1.x;
	this.y = t1.y;
	this.z = t1.z;
	this.w = 1.0;
